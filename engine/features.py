...
class FeatureEngineer:
    ...
    def build_features(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        # DB'den gelen None değerlerini NaN'a çevir (diff/rolling için gerekli)
        numeric_cols = [
            "cart_count", "engagement_score", "favorite_count", "view_count",
            "price", "discounted_price", "discount_rate", "rating_count",
            "avg_rating", "search_rank", "absolute_rank", "page_number",
            "popularity_score", "sales_velocity", "demand_acceleration",
            "velocity_score", "qa_count",
        ]
